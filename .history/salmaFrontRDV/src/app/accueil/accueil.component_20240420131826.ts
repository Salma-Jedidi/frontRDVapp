...
toggleCommentSection(messageId: number): void {
  const commentSection = document.getElementById('commentSection' + messageId);
  console.log('Style de display avant:', commentSection.style.display); // Vérifiez la valeur actuelle
  if (commentSection.style.display === 'none') {
    commentSection.style.display = 'block';
  } else {
    commentSection.style.display = 'none';
  }
  console.log('Style de display après:', commentSection.style.display); // Vérifiez la valeur mise à jour
}
