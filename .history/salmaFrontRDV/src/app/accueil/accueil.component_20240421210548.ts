...
export class AccueilComponent implements OnInit {
  ...
  toggleResponseDetails(index: number): void {
    if (this.showResponseDetails[index] === undefined) {
      this.showResponseDetails[index] = true;
    } else {
      this.showResponseDetails[index] = !this.showResponseDetails[index];
    }
