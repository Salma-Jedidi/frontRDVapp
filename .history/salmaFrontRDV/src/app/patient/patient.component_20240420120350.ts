...
sendMessage(): void {
  this.messageService.sendMessage(this.messagePatient)
    .subscribe((sentMessage: MessagePatient) => {
      console.log('Message envoyé avec succès :', sentMessage);
      // Vous pouvez gérer la réponse du serveur ici, par exemple afficher un message de confirmation à l'utilisateur
    }, error => {
