...
addRDV(): void {
  if (this.rdv.dateRDV !== undefined && this.rdv.heureRdv !== undefined) {
    ...
    console.error('Error: dateRDV or heureRdv is undefined');
  }
}
...
showAvailableTimes(): void {
  if (this.rdv.dateRDV !== undefined) {
    ...
    console.error('Error: dateRDV is undefined');
  }
}
