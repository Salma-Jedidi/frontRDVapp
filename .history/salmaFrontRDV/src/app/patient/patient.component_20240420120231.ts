...
export class PatientComponent  implements OnInit {
  ...
  patient:Patient={
    ...
    messagePatient: MessagePatient = {
      ...
      contenueMessage: '',
      reponseMessage: '',
      dateEnvoieMessage: '', // Assurez-vous de formater correctement cette date si nécessaire
      dateEnvoiReponse: '' // Assurez-vous de formater correctement cette date si nécessaire
    };
     rdvs: RDV[] = [];
     rdvPasses: RDV[] = [];
     rdvAVenir: RDV[] = [];
