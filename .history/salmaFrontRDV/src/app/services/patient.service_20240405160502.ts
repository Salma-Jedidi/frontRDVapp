...
export class PatientService {
  ...
  sendMessage(email: string, contenu: string,message:Messages): Observable<Messages> {
    return this.http.post<Messages> (`${this.apiUrl}/patients/${email}/messages`, { contenu });
  }

  replyMessage(email: string, reponse: string): Observable<Messages> {
    return this.http.post<Messages> (`${this.apiUrl}/patients/${email}/messages/reply`, { reponse });
  }
}
