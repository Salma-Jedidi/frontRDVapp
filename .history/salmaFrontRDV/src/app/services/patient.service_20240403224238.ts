...
export class PatientService {
  ...
  associerDossierMedicalAuPatient(cin: number, idDossier: number): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${cin}/${idDossier}/dossier-medical-patient`, {});
  }
