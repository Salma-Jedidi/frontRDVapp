...
export class PatientService {
  ...
  associerDossierMedicalAuPatient(cin: number, idDossier: number): Observable<DossierMedical> {
    return this.http.post<DossierMedical>(`${this.apiUrl}/${cin}/${idDossier}/dossier-medical-patient`, {});
  }
