...
export class PatientService {
  ...
  associerDossierMedicalAuPatient(cin: number, dossierMedical: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/${cin}/dossier-medical`, dossierMedical)
 
  }

  getDossierMedicalByCin(cin: number): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/${cin}/dossier-medical`)
