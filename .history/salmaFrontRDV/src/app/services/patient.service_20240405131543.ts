...
export class PatientService {
  ...
  sendMessage(email: string, contenu: string): Observable<any> {
    return this.http.post(`${this.baseUrl}/patients/${email}/messages`, { contenu });
  }

  replyMessage(email: string, reponse: string): Observable<any> {
    return this.http.post(`${this.baseUrl}/patients/${email}/messages/reply`, { reponse });
  }
}
