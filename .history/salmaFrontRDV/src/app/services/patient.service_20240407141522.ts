...
export class PatientService {
  ...
  marquerPaiement(idRDV: number, paiementRDV: string): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/marquerPaiement?idRDV=${idRDV}&paiementRDV=${paiementRDV}`, {});
  }

  getRDVPayes(): Observable<RDV[]> {
    return this.http.get<RDV[]>(`${this.baseUrl}/payes`);
  }

  getRDVNonPayes(): Observable<RDV[]> {
    return this.http.get<RDV[]>(`${this.baseUrl}/nonPayes`);
  }
}
