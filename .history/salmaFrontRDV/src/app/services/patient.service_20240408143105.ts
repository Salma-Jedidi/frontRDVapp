...
export class PatientService {
  ...
  sendMessage(nomPatient: string, messagePatient: MessagePatient): Observable<MessagePatient> {
  ...
  replyMessage(email: string, reponse: string,message:MessagePatient): Observable<Messages> {
