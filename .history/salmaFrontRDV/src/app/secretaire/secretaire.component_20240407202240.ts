...
pourcentageRDVPayes(): number {
 ...
 return this.patientService.rendezgetPourcentageRDVPayes().subscribe((pourcentage: number) => {
    // Maintenant, vous avez la valeur du pourcentage récupérée depuis le backend.
