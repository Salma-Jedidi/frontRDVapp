...
getPourcentageRDVPayes(): void {
  this.patientService.getPourcentageRDVPayes().subscribe(pourcentage => {
    this.pourcentageRDVPayes = pourcentage;
  });
...
ngAfterViewInit(): void {
  ...
  const pourcentage = this.getPourcentageRDVPayes();
    ...
    new Chart(pieChartContext, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [this.pourcentageRDVPayes, 100 - this.pourcentageRDVPayes], // Complément pour atteindre 100%
