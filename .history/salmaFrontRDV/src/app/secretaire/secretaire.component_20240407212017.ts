...
nombreRDVModifies: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.getRDVPayes();
    this.getRDVNonPayes();
    this.patientService.getNombreRDVByEtat('ACCEPTER').subscribe(data => {
      console.log("Nombre de RDV Acceptés:", data);
      this.nombreRDVAcceptes = data;
      this.ngAfterViewInit(); // Appelez ngAfterViewInit après chaque mise à jour des données
    });
  
    this.patientService.getNombreRDVByEtat('ANNULER').subscribe(data => {
      console.log("Nombre de RDV Annulés:", data);
      this.nombreRDVAnnules = data;
      this.ngAfterViewInit(); // Appelez ngAfterViewInit après chaque mise à jour des données
    });
  
    this.patientService.getNombreRDVByEtat('ENINSTANT').subscribe(data => {
      console.log("Nombre de RDV En Instant:", data);
      this.nombreRDVEnInstant = data;
      this.ngAfterViewInit(); // Appelez ngAfterViewInit après chaque mise à jour des données
    });
  
    this.patientService.getNombreRDVByEtat('MODIFIER').subscribe(data => {
      console.log("Nombre de RDV Modifiés:", data);
      this.nombreRDVModifies = data;
      this.ngAfterViewInit(); // Appelez ngAfterViewInit après chaque mise à jour des données
    });
  }
  getAllPatients() {
      ...
      datasets: [
        {
          ...
          data: [this.nombreRDVAcceptes, this.nombreRDVAnnules, this.nombreRDVEnInstant, this.nombreRDVModifies],
